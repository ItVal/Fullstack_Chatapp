...
import logo from "../assets/513FFDEWyJL.png"

const Navbar = () => {
  return (
    <div>
      <nav class="bg-white border-gray-200 px-2 ml-28 mr-20 sm:px-4 py-2.5 rounded dark:bg-gray-900">
    <div class="container flex flex-wrap items-center justify-between mx-auto">
      <a href="https://flowbite.com/" class="flex items-center">
      <img src={logo} alt="logo" className=" items-center h-12 w-12 " />
          <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Chat'Me</span>
      </a>
