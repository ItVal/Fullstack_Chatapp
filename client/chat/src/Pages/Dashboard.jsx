...
const Dashboard = (props) => {
  ...
  return (
    <div className="card relative flex flex-col justify-center h-auto overflow-scr">
      <div className="text-3xl font-semibold text-center text-purple-700 uppercase">Bienvenus</div>
      ...
      <button className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-purple-700 rounded-md hover:bg-purple-600 focus:outline-none focus:bg-purple-600">Create Chatroom</button>
