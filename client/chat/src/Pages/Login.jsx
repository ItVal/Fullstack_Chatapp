...
const Login = (props) => {
  ...
  return (
    <>
      ...
      <div className="login relative flex flex-col justify-center mt-0 h-[85vh] overflow-hidden">
        <div className="cont w-full p-3 ml-auto mb-20 mr-auto bg-[#494949] rounded-md shadow-xl lg:max-w-lg">
          <div className="text-3xl font-semibold text-center text-white uppercase">
            Login
          </div>
          ...
          <div className="flex orbtn w-[80%] mt-4 gap-x-2">
            <button
              type="button"
              className="flex items-center justify-center w-[70%] p-2 border border-gray-[#40e66a] bg-[#03989e] hover:bg-[#40e66a] rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-violet-600"
            >
              <svg
            ...
            <button className="flex items-center justify-center w-[70%] p-2 border border-[#40e66a] hover:bg-[#40e66a] rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-violet-600">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 32 32"
                className="w-5 h-5 fill-current"
            ...
            <button className="flex items-center justify-center w-[70%] p-2 border border-gray-[#40e66a] hover:bg-[#40e66a] rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-violet-600">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 32 32"
                className="w-5 h-5 fill-current"
